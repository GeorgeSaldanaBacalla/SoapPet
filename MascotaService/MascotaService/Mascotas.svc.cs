...
namespace MascotaService
{
    ...
    public class Mascotas : IMascotas
    {
        ...
        public Mascota ModificarMascota(Mascota mascotaModificar)
        {
            return dao.Modificar(mascotaModificar);
        }

        public void EliminarMascota(Mascota mascotaEliminar)
        {
            dao.Eliminar(mascotaEliminar) ;
        }

        public IList<Mascota> ListarMascota()
        {
